...
namespace FunctionsHost
{
    ...
    public class ProcessMessage
    {
        ...
        public bool IsExternalRequest => DeploymentTimestamp == default(DateTime);
        public bool IsSequenced => LastClock.HasValue;
        public bool IsLoopback => ! LastClock.HasValue && DeploymentTimestamp != default(DateTime);
        ...
        {
            return LastClock.HasValue ? $"Sequenced p{Source:D3}.{LastClock}" : IsExternalRequest ? "Client" : "Loopback";
        }
    }
